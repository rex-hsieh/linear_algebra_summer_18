...
\begin{enumerate}[itemsep = 1.5mm]
	...
	\end{bmatrix}
	\end{align*}
	so the system has 1 pivot column (the first one), and the rest are free variables. Also, the solution set does depend on $x_3$. Hence, we have the solution set
	\begin{align}
	\label{eq2}
	\tag{$\ast$}
